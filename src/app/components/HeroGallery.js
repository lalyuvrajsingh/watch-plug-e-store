  ...
  return (
    <section className="relative w-full h-screen overflow-hidden bg-black">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center z-10 w-full max-w-[900px] px-8">
        <h1 className="text-[2.5rem] md:text-[4.5rem] font-normal leading-tight mb-8 md:mb-12 tracking-[-0.02em] text-white/95">
          Timeless Elegance<br />Modern Legacy
        </h1>
        <button 
          onClick={scrollToProducts}
          className="inline-block px-8 md:px-10 py-3 md:py-4 text-lg md:text-xl font-medium text-black bg-white rounded-full hover:-translate-y-0.5 hover:bg-white/90 hover:shadow-[0_6px_20px_rgba(255,255,255,0.15)] transition-all duration-300 active:translate-y-0 shadow-[0_4px_15px_rgba(255,255,255,0.1)]"
        >
          Explore
        </button>
      </div>
      ...
      {isMobile ? (
        <>
          <FloatingImage 
            ...
            className="w-[150px] h-[200px] top-[5%] left-[10%] opacity-90"
            parallaxSpeed={0.02}
          />
          <FloatingImage 
            src="/watch-image/Colorful Luxe Collectio.jpeg"
            className="w-[150px] h-[200px] top-[5%] right-[10%] opacity-90"
            parallaxSpeed={-0.01}
          />
          <FloatingImage 
            src="/watch-image/Limited Edition Richard Mille RM 57-03 Tourbillon Sapphire Dragon for Asia Only.jpeg"
            className="w-[150px] h-[150px] bottom-[5%] left-[10%] opacity-90"
            parallaxSpeed={0.1}
          />
          <FloatingImage 
            src="/watch-image/Luxury Watches in Dubai 🕰️✨.jpeg"
            className="w-[150px] h-[150px] bottom-[5%] right-[10%] opacity-90"
            parallaxSpeed={-0.05}
          />
        </>
      ) : (
